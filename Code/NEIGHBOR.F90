...
! X- neighbor 
    recursive function NeighborX1(c) RESULT(Neighbor)
        implicit none
        type(typOctCell),pointer :: c,cf,cinitial,cfn,Neighbor
        ...
        if(.not.associated(cf))then
            if(c%nBGCell(1)==1)then
                ...
                Neighbor=>OctCell(c%nBGCell(1)-1,c%nBGCell(2),c%nBGCell(3))
            endif
            return
        endif
    ...
    recursive function NeighborY1(c) RESULT(Neighbor)
        ...
        if(.not.associated(cf))then
            if(c%nBGCell(2)==1)then
                ...
                Neighbor=>OctCell(c%nBGCell(1),c%nBGCell(2)-1,c%nBGCell(3))
            endif
            return
        endif
    ...
    recursive function NeighborZ1(c) RESULT(Neighbor)
        ...
        if(.not.associated(cf))then
            if(c%nBGCell(3)==1)then
                ...
                Neighbor=>OctCell(c%nBGCell(1),c%nBGCell(2),c%nBGCell(3)-1)
            endif
            return
        endif
